...
#
# Script generated by Vivado on Sun Jun 01 22:50:22 EDT 2025
...
# script info
echo -e "floating_point_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hp/Desktop/hassan_ai/dpe_git/dpe_v1.3/dot_product_integration/dot_product_sim.cache/compile_simlib/modelsim"
  fi
